...
$cond = ' vehicle_category = category_id '.((isset($UTYPE) && $UTYPE == 'SA') ? '' : ' AND vehicle_createdby = "' . $_SESSION['UID'] . '" ');//$user->user_branch
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="display" id="grid-data" width="100%">
        ...
        <tbody>
            ...
            while ($data = mysql_fetch_object($vehicle)) {
                ...
                echo '<td class="center">', ($data->vehicle_status == 'W' ? '' : 'Not-'), 'Working</td>';
