<?php
	...
	$cond = " date BETWEEN '".$batch->batch_startdt."' AND '".$batch->batch_enddt."' AND att_batch_id='".$att_batch_id."' AND att_branch_id='".$att_branch."' " ;
    ...
    <table cellspacing="0" cellpadding="0" class="listing form">
		...
		<tbody>
			<tr class="bg">
				...
				<td><?php echo $student->std_fname,' ',$student->std_lname;?></td>				
				<td<?php
				if ($db->getRowCount() > 0) {
				...
				echo $class,'>',$att_percent;
				//echo $present_days,'--',$total_classes_conducted;				
				}else{
					echo ' style="color:#F00">0';
				}
				?>%</td>
			 </tr>
		</tbody>
