...
$category = $db->fetchAllRecord(' tb_vehicle_categories ', ' category_id, category_name, category_status ', $cond, NULL, null, NULL, 0, 'All');
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="display" id="grid-data" width="100%">
        ...
        <tbody>
            ...
            while ($data = mysql_fetch_object($category)) {
                ...
                echo '<td class="center"><a href="vehicle_category.php?op=E&amp;id=', $data->category_id, '" title="Edit Category" alt="Edit Category"><div class="img edit"></div></a>&nbsp;';
                if(chkCategory($data->category_id)){//
                    echo '<a href="../admin/logic/vehicle_category_logic.php?op=D&amp;id=', $data->category_id, '" title="Delete category" alt="Delete category"><div class="img delete"></div></a>';
                }else{
                    echo '&nbsp;&nbsp;&nbsp;';
                }
                echo '</td></tr>', "\n";
