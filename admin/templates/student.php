<div class="content-warp">
  <div class="table">
    <form method="post" name="studentForm" id="studentForm" action="./logic/student_logic.php?type=<?php echo $action ;?>&amp;op=<?php echo $op;?>" enctype="multipart/form-data">
      <table cellspacing="0" cellpadding="0" class="listing form">
        <tbody class="fields">
          ...
          <tr>
            ...
            <td class="last"><input type="text" value="<?php echo $std_email ?>" id="std_email" maxlength="255" name="std_email" class="text"></td>
            <td class="first"><strong>Secondary E-mail</strong></td>
            <td class="last"><input type="text" value="<?php echo $std_secondary_email; ?>" maxlength="255" id="std_secondary_email" name="std_secondary_email" class="text"></td>
          </tr>
          <tr class="bg">
            <td class="first"><strong>Primary Phone No.</strong><span class="complsory">*</span></td>
            <td class="last"><input type="text" value="<?php echo $std_phno; ?>" maxlength="10" id="std_phno" name="std_phno" class="text"></td>
            <td class="first"><strong>Secondary Phone No.</strong></td>
            <td class="last"><input type="text" value="<?php echo $std_sphone; ?>" maxlength="10" id="std_sphone" name="std_sphone" class="text"></td>
          </tr>
		  <?php
		  if($UTYPE !== 'ES'){
		  ?>
          <tr>
            <td class="first"><strong>Batch Name</strong></td>
            <td class="last"><?php echo $batch_rec->batch_name ; ?></td>
            <td class="first"><strong>Access Card</strong></td>
            <td class="last"><input type="text" value="<?php echo $std_access_card; ?>" id="std_access_card" name="std_access_card" class="text"<?php echo (($std_access_card != '') ? ' readonly' : '' );?>></td>
          </tr>
		  <?php
		  }
		  ?>
          ...
          <tr class="bg">
            ...
            <td colspan="3" class="last" valign="top"><input type="file" id="std_photo" value="" name="std_photo" title="Photo" style="width:85%" class="text"><?php //echo ((!isset($std_photo) ||(isset($std_photo) && $std_photo==''))?' required':'');?> 
              <?php
								if($std_photo!='')
								{			
          ...
          <tr class="bg">
            ...
            <td class="last">
				<label for="std_gender_f"><input type="radio" value="F" id="std_gender_f" name="std_gender"<?php echo ((!isset($std_gender) || ($std_gender == 'F')) ? ' checked="checked"': ''); ?>>&nbsp;Female</label>
				<label for="std_gender_m"><input type="radio" value="M" id="std_gender_m" name="std_gender"<?php echo (isset($std_gender) && ($std_gender == 'M')) ? ' checked="checked"': ''; ?>>&nbsp;Male</label>			
			</td>			
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="last"><input type="text" value="<?php echo $std_ssc_percentage ?>" id="std_ssc_percentage" name="std_ssc_percentage" class="text" style="width: 100px;">
              % </td>
          </tr>
          <tr class="bg">
            ...
            <td class="last"><input type="text" value="<?php echo $std_ipe_percentage ?>" id="std_ipe_percentage" name="std_ipe_percentage" class="text" style="width: 100px;" >
              % </td>
          </tr>
          <tr>
            ...
            <td class="last"><input type="text" value="<?php echo $std_diploma_percentage ?>" id="std_diploma_percentage" name="std_diploma_percentage" class="text" style="width: 100px;" >
              % </td>
          </tr>
          <tr class="bg">
            ...
            <td class="last"><input type="text" value="<?php if(isset($std_graduation_percentage)){ echo $std_graduation_percentage;} ?>" id="std_graduation_percentage" name="std_graduation_percentage" class="text" style="width: 100px;" >
              % </td>
          </tr>
          <tr>
           ...
           <td class="last" colspan="3">
                            ...
                            <select name="std_graduation_college" id="std_graduation_college">
          ...
          <td class="last" colspan="3">
		  <input type="text" name="std_graduation_other" id="std_graduation_other" value="<?php echo $std_graduation_other ?>"
          	</td>
        </tr>
		<tr class="bg">
            <td class="first"><strong>Graduation Branch</strong><span class="complsory">*</span></td>
           <td class="last">
                            <select name="std_graduation_branch" id="std_graduation_branch">
                                <option value="">-- Select --</option>
							   <?php
				...
				<td class="first"><strong>University Seat Number(USN)</strong></td>
				<td class="last"><input id="std_gusno" class="text" type="text" name="std_gusno" value="<?php echo $std_gusno;?>"></td>
          </tr>
          ...
          <td class="last" colspan="3"><input type="text" name="std_grbranch_other" id="std_grbranch_other" value="<?php echo $std_grbranch_other ?>">
          	</td>
        </tr>
		<tr>
			<td class="first"><strong>Total Number of Arrears</strong></td>
			<td class="last"><input id="std_garrears" class="text" type="text" name="std_garrears" value="<?php echo $std_garrears;?>"></td>
			<td class="first"><strong>Current Backlogs</strong></td>
			<td class="last"><input id="std_gblogs" class="text" type="text" name="std_gblogs" value="<?php echo $std_gblogs;?>"></td>
          </tr>
          <tr>
            ...
            <td class="last"><input type="text" value="<?php echo $std_postgraduate_pecentage; ?>" id="std_postgraduate_pecentage" name="std_postgraduate_pecentage" class="text" style="width: 100px;" >
              % </td>
          </tr>
          <tr>
          ...
          <td class="first" valign="top"><strong>College Name</strong></td>
          <td class="last" colspan="3">
			<input type="text" name="std_postgraduation_other" id="std_postgraduation_other" value="<?php echo $std_postgraduation_other ?>"></td>
        </tr>
		
		<tr>
           <td class="first"><strong>Post Graduation Branch</strong></td>
           <td class="last">          	
				<select name="std_postgraduation_branch" id="std_postgraduation_branch"  tabindex="1">
					<option value="">-- Select --</option>          
				   <?php
			...
			<td class="first"><strong>University Seat Number(USN)</strong></td>
			<td class="last"><input id="std_pusno" class="text" type="text" name="std_pusno" value="<?php echo $std_pusno;?>"></td>
          </tr>
		  <tr>
			<td class="first"><strong>Total Number of Arrears</strong></td>
			<td class="last"><input id="std_parrears" class="text" type="text" name="std_parrears" value="<?php echo $std_parrears;?>"></td>
			<td class="first"><strong>Current Backlogs</strong></td>
			<td class="last"><input id="std_pblogs" class="text" type="text" name="std_pblogs" value="<?php echo $std_pblogs;?>"></td>
          </tr>
          ...
          <td class="last" colspan="3">
			<input type="text" name="std_ptgrbranch_other" id="std_ptgrbranch_other" value="<?php echo $std_ptgrbranch_other ?>">
			</td>
        </tr>
          <tr>
          ...
          <tr class="bg">
            <td class="first"><strong>Resume</strong></td>
            <td colspan="3" class="last"><input type="file" id="std_resume" value="" title="Resume" name="std_resume" class="text"><?php //echo ((!isset($std_resume) ||(isset($std_resume) && $std_resume==''))?' required':'');?>
			...
			?>
			  <tr class="bg">
                        ...
                        <td colspan="3" class="last">
                            ...
                            <input type="radio" class="textarea" name="user_status" value="D"<?php echo ($user_status == 'D' ? ' checked' : ''); ?>>&nbsp;In-Active&nbsp;
                        </td>
              </tr>
              <?php
		}
      ...
      <p class="buttons">
        <?php
		   if(isset($pagefrom) && $pagefrom == 'profile')
			...
			?>
        <input name="std_type" id="std_type" type="hidden" value="<?php echo $std_type;?>">
		<input name="utype" id="utype" type="hidden" value="<?php echo $utype;?>">
        <input name="id" id="id" type="hidden" value="<?php echo $id;?>">
        <input name="pagefrom" id="pagefrom" type="hidden" value="<?php echo isset($pagefrom) ? $pagefrom : '';?>">
        <?php
        if(isset($UTYPE) && ($UTYPE == 'AD' || $UTYPE == 'SA'))
		{
			if(isset($user_type) && $user_type == 'SD')
			{
				?>
			...
			if(isset($user_type) && $user_type == 'GS')
			{
			?>
			...
			?>
			<input name="Cancel" type="button" value="Cancel" class="login cancel" onclick="javascript: window.document.location.href='welcome.php';">
			<?php
		}
        ?>
