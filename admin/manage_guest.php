...
$tables = (!isset($utype) || $utype == 'AD') ? ' tb_users U ' : ' tb_users U, tb_users US ';
...
$result = $db->fetchAllRecord($tables, ' U.user_id, U.user_name, U.user_fullname, U.user_email, U.user_status,U.user_branch ', $cond, NULL, '  user_name', NULL, 0, 'All');
?>
<div id="main">
    <div id="sts"></div>
...
while ($data = mysql_fetch_object($result)) {
    ...
    echo '<td class="center"><a href="student.php?op=E&amp;id=', $data->user_id, '" title="Edit"><div class="img edit"></div></a>&nbsp;';
    echo '<a href="../admin/logic/student_logic.php?op=D1&amp;id=', $data->user_id, '&amp;utype=', $utype, '" title="Delete"><div class="img delete"></div></a>';
    if(isset($UTYPE) && $UTYPE == 'SA')
	{
    echo '<a href="../admin/changepassword.php?id=', $data->user_id, '&amp;uname=', $data->user_name, '" title="Change Password"><img src="img/change.png" /></a>';
	}
    echo '</td></tr>', "\n";
    $row++;
}
