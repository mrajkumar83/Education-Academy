<div class="content-warp">
    <div class="table">
        <form method="post" name="categoryForm" id="categoryForm" action="../admin/logic/vehicle_category_logic.php?op=<?php echo $op; ?>">
            <table cellspacing="0" cellpadding="0" class="listing form">
                <tbody>
                    <tr>
                        <th colspan="4" class="full">Vehicle Category</th>
                    </tr>
                    <tr class="bg">
            ...
            <p class="buttons">
                ...
                <input type="reset" value="Cancel" name="Cancel" onclick="document.location.href='manage_vehicle_category.php'">
                &nbsp; &nbsp;
